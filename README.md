...
[![Coverage Status](https://coveralls.io/repos/github/similarweb/statusbay/badge.svg?branch=feature/add-code-coverage-coveralls)](https://coveralls.io/github/similarweb/statusbay?branch=master)
