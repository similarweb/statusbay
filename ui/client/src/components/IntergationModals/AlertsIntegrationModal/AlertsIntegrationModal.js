...
const AlertsIntegrationModal = () => {
  ...
  return (
    <div>
      ...
      <Dialog open={isOpen} onClose={handleDialogClose} closeAfterTransition={true} onBackdropClick={handleDialogClose} maxWidth="lg">
        <Box p={2}>
          <Typography variant="h4">Alert Integration:</Typography>
          <Typography variant="body1">
          StatusBay has the ability to show different alerts for different set of tags. More info at 
            {' '}
          ...
          <Typography className={classes.code}>    statusbay.io/alerts-statuscake-tags: nginx,production</Typography>
...
export default AlertsIntegrationModal;
